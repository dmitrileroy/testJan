...
const useQ4042ResponsiveSize = () => {
  ...
  React.useEffect(() => {
    ...
    const ScreenMobileSize = window.matchMedia('(max-width: 544px)');
    ...
    const ScreenTabletSize = window.matchMedia(
      '(min-width: 545px) and (max-width: 1104px)'
    );
...
export default useQ4042ResponsiveSize;
