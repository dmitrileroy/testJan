...
import ArrowForwardFilled1 from 'public/newassets/images/_ArrowForwardFilled.svg';
import { styled } from '@mui/material/styles';
import useQ4042 from 'components/Q4042/useQ4042';
...
const Hero = styled('div', {
  ...
  backgroundImage:
    data.currentVariant === 'ScreenTablet'
      ...
      : data.currentVariant === 'ScreenMobile'
      ? 'unset'
      : `url(newassets/images/4042_Hero.png)`,
  backgroundPosition:
    data.currentVariant === 'ScreenTablet'
      ? 'unset'
      : data.currentVariant === 'ScreenMobile'
...
const FillHero = styled('div', {
  ...
  backgroundImage:
    data.currentVariant === 'ScreenTablet'
      ? `url(newassets/images/undefined)`
      : data.currentVariant === 'ScreenMobile'
      ? `url(newassets/images/undefined)`
      : 'unset',
  backgroundPosition:
