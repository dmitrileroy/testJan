...
import useAboutUs2 from 'components/AboutUs2/useAboutUs2';
...
const FrontEndSubtitle = styled('div', {
  shouldForwardProp: (prop) => !['data'].includes(prop.toString()),
})(({ data }) => ({
  textAlign: `left`,
  whiteSpace: `pre-wrap`,
...
const WeBelieveDesktop = styled('div', {
  shouldForwardProp: (prop) => !['data'].includes(prop.toString()),
})(({ data }) => ({
  display: `flex`,
  position: `relative`,
...
const WeBelieveMobile = styled('div', {
  shouldForwardProp: (prop) => !['data'].includes(prop.toString()),
})(({ data }) => ({
  display: `flex`,
  position: `relative`,
...
const HeroBg = styled('div', {
  ...
  backgroundImage: `url(newassets/images/AboutUs2_heroBG.png)`,
...
const SecBlurDesktop = styled('div', {
  shouldForwardProp: (prop) => !['data'].includes(prop.toString()),
})(({ data }) => ({
  background:
    data.currentVariant === 'ScreenMobile'
...
const SecBlurMobile = styled('div', {
  shouldForwardProp: (prop) => !['data'].includes(prop.toString()),
})(({ data }) => ({
...
const StatIcon1 = styled('img')({
  height: `76px`,
  width: `76px`,
  margin: `0px`,
});

const BtmTxt1 = styled('div', {
  shouldForwardProp: (prop) => !['data'].includes(prop.toString()),
})(({ data }) => ({
  display: `flex`,
  position: `relative`,
...
const StatIcon2 = styled('img')({
  height: `76px`,
  width: `76px`,
  margin: `0px`,
});

const BtmTxt2 = styled('div', {
  shouldForwardProp: (prop) => !['data'].includes(prop.toString()),
})(({ data }) => ({
  display: `flex`,
  position: `relative`,
          ...
          <SecHolder>
            <Sec2Text>
              <SecBlur data={data}>
                <Subtitle>
                  <ActionsIcon
                    src={`newassets/images/AboutUs2_Actions_Icon.png`}
                    loading="lazy"
                    alt={'Actions Icon'}
                  />
                  <AboutUs>{`OUR MISSION`}</AboutUs>
                </Subtitle>
                <LargeTxt data={data}>
                  <Title>
                    <EveryTeam data={data}>
                ...
                <WeBelieveTxt data={data}>
                  ...
                  <Bullet data={data}>
                    <BulletMoved data={data}>
                      <Dot
                        src={`newassets/images/AboutUs2_dot.png`}
                        loading="lazy"
                        alt={'dot'}
                      />
                    </BulletMoved>
                  ...
                  <Bullet1 data={data}>
                    <BulletMoved1 data={data}>
                      <Dot1
                        src={`newassets/images/AboutUs2_dot_1.png`}
                        loading="lazy"
                        alt={'dot'}
                      />
                    </BulletMoved1>
                  ...
                  <Bullet2>
                    <BulletMoved2 data={data}>
                      <Dot2
                        src={`newassets/images/AboutUs2_dot_2.png`}
                        loading="lazy"
                        alt={'dot'}
                      />
                    </BulletMoved2>
            ...
            <Sec1Text>
              {!(data.currentVariant === 'ScreenMobile') && (
                <SecBlurDesktop data={data}>
                  <Subtitle1>
                    <ActionsIcon1
                      src={`newassets/images/AboutUs2_Actions_Icon_1.png`}
                      loading="lazy"
                      alt={'Actions Icon'}
                    />
                    <AboutUs1>{`WE ARE`}</AboutUs1>
                  </Subtitle1>
                  <LargeTxt1 data={data}>
                    <Q1Line>
                      <A data={data}>{`A`}</A>
...
`
              ...
              {data.currentVariant === 'ScreenMobile' && (
                <SecBlurMobile data={data}>
                  <Subtitle2>
                    <ActionsIcon2
                      src={`newassets/images/AboutUs2_Actions_Icon_2.png`}
                      loading="lazy"
                      alt={'Actions Icon'}
                    />
          ...
          <SecHolder2 data={data}>
            <Sec3Text>
              <SecBlur1 data={data}>
                <Subtitle3>
                  <ActionsIcon3
                    src={`newassets/images/AboutUs2_Actions_Icon_3.png`}
                    loading="lazy"
                    alt={'Actions Icon'}
                  />
                ...
                <Cards data={data}>
                  <Card data={data}>
                    <Form>
                      <StatIcon
                        src={`newassets/images/AboutUs2_stat_icon.png`}
                        loading="lazy"
                        alt={'stat_icon'}
                      />
                      <BtmTxt data={data}>
...
`}
                  ...
                  <Card1 data={data}>
                    <Form1>
                      <StatIcon1
                        src={`newassets/images/AboutUs2_stat_icon_1.png`}
                        loading="lazy"
                        alt={'stat_icon'}
                      />
                      <BtmTxt1 data={data}>
                  ...
                  <Card2 data={data}>
                    <Form2>
                      <StatIcon2
                        src={`newassets/images/AboutUs2_stat_icon_2.png`}
                        loading="lazy"
                        alt={'stat_icon'}
                      />
                      <BtmTxt2 data={data}>
